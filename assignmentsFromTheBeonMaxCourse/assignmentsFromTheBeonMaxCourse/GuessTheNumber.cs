...
namespace assignmentsFromTheBeonMaxCourse
{
    public class GuessTheNumber
    {
        ...
        public string guessNumber = ("Загадайте число от 0 до 10");
        public int attempt = 5;
        public int inputGuessNumber = 0;
        public int randomazer = new Random().Next(0, 10);
        ...
        //Соответственно и угадывать может как человек, так и машина.Это значит, что надо реализовать два режима игры: когда загадывает машина и когда загадывает человек.
